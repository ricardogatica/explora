...
export function meta({ data, params }) {
  const ficha = fichaDe("constellations", params.slug);
  return ficha
...
export default function Pagina({ params }) {
  const ficha = fichaDe("constellations", params.slug);
  if (!ficha) return <NoExiste que="una constelación" />;
  return <Ficha ficha={ficha} hermanos={hermanosDe("constellations", params.slug)} />;
}
